...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll(".send-video").forEach(button => {
        button.addEventListener("click", function() {
            ...
            responseDiv.innerHTML = `<p class="text-info">Uploading video... Please wait.</p>`;
            ...
            .catch(error => {
                ...
                responseDiv.innerHTML = `<p class="text-danger">Error uploading video.</p>`;
                //enable the button
                button.disabled = false;
            });
        });
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll(".send-audio").forEach(button => {
        button.addEventListener("click", function() {
            ...
            responseDiv.innerHTML = `<p class="text-info">Uploading audio... Please wait.</p>`;
            ...
            .catch(error => {
                console.error("Error:", error);
                responseDiv.innerHTML = `<p class="text-danger">Error uploading audio.</p>`;
                //enable the button
                button.disabled = false;
            });
        });
